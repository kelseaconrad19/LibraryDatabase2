    ...
    while True:
        ...
        if book_menu_choice == "1":  # Add a new book
            ...
            try:
                ...
                print(f"Error: {e}")
        elif book_menu_choice == "2":  # Delete a book
        ...
        elif book_menu_choice == "3":  # Search for a book
        ...
        elif book_menu_choice == "4":  # Borrow a book
            ...
            if book:
                ...
                print(f"{title} not found.")
        elif book_menu_choice == "5":  # Return a book
            ...
            if book:
                ...
                print(f"{title} not found.")
        elif book_menu_choice == "6":  # Display all Books
            Book.display_all_books(database)

        elif book_menu_choice == "7":  # Quit
            break
        else:
            print("Invalid choice. Please try again.")
...
def genre_operations(database=db):
    print("Genre Operations")
    while True:
        genre_choice = input(
            "1. Add a new genre\n2. View genre details\n3. Display all genres\n4. Quit\n")
        if genre_choice == '1':  # Add a new genre
            ...
            genre = Genre(name, db, description, category)
            genre.save_new_genre()
        elif genre_choice == '2':  # View genre details
            name = input("Enter the genre's name: ")
            Genre.display_genre_info(name, database)
        elif genre_choice == '3':  # Display all genres
            Genre.display_all_genres(database)
        elif genre_choice == '4':
            break
